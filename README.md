...
`wget https://github.com/rclarkburns/donut/archive/1.0.8.tar.gz`

Extract release
`tar -xf 1.0.8.tar.gz`

Run setup inside the release dir
`cd donut-1.0.8 && ./setup`

_Alternative combined approach_

`mkdir donut && cd donut && wget https://github.com/castiron/donut/archive/1.0.8.tar.gz && tar -xf 1.0.8.tar.gz && cd donut-1.0.8 && ./setup && cd -`
